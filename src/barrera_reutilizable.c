...
int main(int argc, char *argv[])
{
	...
	if(argc > 1) N = atoi(argv[1]); //Convierte argv[1] a entero con atoi
	if(argc > 2) E = atoi(argv[2]); //Convierte argv[2] a entero con atoi
	...
	for(int i=0; i<N; i++) { //esperar a que terminen
